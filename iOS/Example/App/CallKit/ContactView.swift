...
public class ContactView: UIView {
    ...
    public init(frame: CGRect = .zero, type: SelectUserButtonType, selectHandle: @escaping ([V2TIMUserFullInfo])->Void) {
...
private extension String {
    static let yourUserNameText = TUICallKitAppLocalize("TUICallKitApp.yourID")
    static let searchPhoneNumberText = TUICallKitAppLocalize("TUICallKitApp.searchID")
    static let searchText = TUICallKitAppLocalize("TUICallKitApp.searching")
    static let backgroundTipsText = TUICallKitAppLocalize("TUICallKitApp.searchandcall")
    static let failedSearchText = TUICallKitAppLocalize("TUICallKitApp.searchingfailed")
    static let cantInvateSelfText = TUICallKitAppLocalize("TUICallKitApp.cantinviteself")
}
