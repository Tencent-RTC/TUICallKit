...
### 步骤2：配置 Demo 工程文件
打开 debug 文件夹下的 `GenerateTestUserSig.js` 文件，填写 SDKAPPID 和 SECRETKEY。
```javascript
/**
...
2. 填写您微信小程序的 AppID，单击**导入**。
   ![](https://qcloudimg.tencent-cloud.cn/raw/2180af08085b8782810af2c316d0df18.png)
