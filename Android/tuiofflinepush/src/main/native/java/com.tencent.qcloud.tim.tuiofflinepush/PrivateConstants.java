...
public class PrivateConstants {
    ...
    // 海外证书 ID，需要在海外控制台配置，不使用不用填写  // The overseas certificate ID, which needs to be configured on the overseas console, does not need to
    // be filled in if it is not used.
    ...
    // FCM 通道预创建通知栏的推送铃音名称，raw 目录下不需要后缀名。 //The name of the push ringtone for the pre-created notification bar of the FCM channel. The
    // suffix is not required in the raw directory
