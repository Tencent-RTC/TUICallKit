        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final ItemEntity model, final int position,
                ...
                if (model.mIsSelected) {
                    ...
                    mItemImg.setBorderColor(getResources().getColor(R.color.audio_white));
                    mTitleTv.setTextColor(getResources().getColor(R.color.audio_white));
                } else {
                    mItemImg.setBorderWidth(0);
                    mItemImg.setBorderColor(getResources().getColor(android.R.color.transparent));
                    mTitleTv.setTextColor(getResources().getColor(R.color.audio_white_alpha));
                }
