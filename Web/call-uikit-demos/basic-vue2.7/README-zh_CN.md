...
<a href="https://github.com/tencentyun/TUICallKit/blob/main/Web/demos/basic-vue2.7/README.md"> English </a> | <b> 简体中文 </b> 
...
本节向您展示测试腾讯调用 Web Vue2.7 演示所需的先决条件。

#### 条件

Calls SDK for Web Vue2.7 demo 的最低要求是：
