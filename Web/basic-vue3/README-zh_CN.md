...
<a href="https://github.com/tencentyun/TUICallKit/blob/main/Web/call-uikit-demos/basic-vue3/README.md"> English </a> | <b> 简体中文 </b>
...
3. 配置 SDKAppID 和 SDKSecretKey 在 `Web/call-uikit-demos/basic-vue3/public/debug/GenerateTestUserSig-es.js` 文件中填写 SDKAppID 和 SecretKey。
  ```javascript
   const SDKAPPID = 0;
   const SECRETKEY = '';
  ```
